      ...
      <v-container>
        ...
        <v-card class="pa-4 mb-4">
          ...
          <v-form @submit.prevent="submitWork">
            ...
            <v-file-input v-model="files" label="Attach Files (Max 3)" multiple :rules="fileRules" counter show-size
              accept="image/*,application/pdf"></v-file-input>
        ...
        <v-card class="pa-4">
          ...
          <v-expansion-panels>
            <v-expansion-panel v-for="work in works" :key="work.id" class="my-2">
                  ...
                  <div v-if="work.files && decodedFiles(work.files).length">
                    ...
                    <ul>
                      <li v-for="file in decodedFiles(work.files)" :key="file">
                        <a :href="`${getDownloadURL(file)}`" @click.prevent="downloadFile(getDownloadURL(file))"
                          target="_blank">
                          {{ getFileName(file) }}
                        </a>
                      </li>
