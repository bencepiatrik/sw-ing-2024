        ...
        $universities = [
            ...
            'Univerzita Konštantína Filozofa v Nitre' => [
                ...
                'Fakulta sociálnych vied a zdravotníctva' => [
                    ...
                    'Útav aplikovanej psychológie',
                    'Útav romologických štúdií',
                ],
                'Fakulta stredoeurópskych štúdií' => [
                    'Katedra cestovného ruchu',
                    'Útav maďarskej jazykovedy a literárnej vedy',
                    'Útav pre vzdelávanie pedagógov',
                    'Útav stredoeurópskych jazykov a kultúr',
                ],
                'Filozofická fakulta' => [
                    'Katedra anglistiky a amerikanistiky',
                    'Katedra archeológie',
                    ...
                    'Útav literárnej a umeleckej komunikácie',
                    'Útav manažmentu kultúry a turizmu, kulturológie a etnológie',
                    'Útav pre výskum kultúrneho dedičstva Konštantína a Metoda',
                ],
                'Pedagogická fakulta' => [
